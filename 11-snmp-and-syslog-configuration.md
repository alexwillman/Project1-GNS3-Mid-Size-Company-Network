...
- Configuring Ubuntu-Mon-Server with a static IP, hostname, and base services
- Installing and configuring snmpd on Ubuntu-Mon-Server
- Configuring SNMP on all switches
- Installing and configuring rsyslog on Ubuntu-Mon-Server
- Configuring Syslog on all switches, servers, and pfSense
- Verify these services are functioning correctly. 
