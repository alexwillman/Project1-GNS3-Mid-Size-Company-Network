...
This section will include an addition to the topology. It will cover:
- The set up of a cloud node for browser access to pfSense
...
- Set the Interface to WAN
- Set the Source to Network or Alias
- In the box next to Network or Alias type 172.16.0.128 with a /25 mask
- Set Destination to Any
- In Description type Server NAT
- Click Save then Apply Changes
